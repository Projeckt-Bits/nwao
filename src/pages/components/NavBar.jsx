...
function RotateArrow() {
  ...
  if (State == 0) {
    Arrow.style.cssText = "transform: rotate(180deg); transition: all 100ms ease-in-out";
    
    State = 1;
  } else {
    Arrow.style.cssText = "transform: rotate(0deg); transition: all 100ms ease-in-out";
